...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w3dgpci.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w3dgpci.containers.anotherwebservice.com/
...
```
git clone git@github.com:TheChosenCactus/container-w3dgpci.git
cd container-w3dgpci
```
...
```
docker attach container-w3dgpci
```
